                        ...
                        <div style={{ padding: '36px 36px 28px' }}>
                            ...
                            {googlePendingStep ? (
                                <form onSubmit={handleGooglePasswordSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                                    <div style={{ padding: '10px 14px', border: '1px solid var(--ac-a28)', background: 'var(--ac-a08)', borderRadius: 3, fontFamily: 'var(--font-display)', fontSize: 10, letterSpacing: '0.1em', color: 'var(--c-ac)' }}>
                                    ...
                                    <div style={{ textAlign: 'center' }}>
                                        <button type="button" onClick={() => { setGooglePendingStep(false); setGoogleSitePassword(''); setError(''); }} style={{ background: 'transparent', border: 'none', color: 'var(--c-tx3)', fontFamily: 'var(--font-display)', fontSize: 9, letterSpacing: '0.22em', textTransform: 'uppercase', cursor: 'pointer', transition: 'color 150ms' }} onMouseOver={e => e.currentTarget.style.color = 'var(--c-ac)'} onMouseOut={e => e.currentTarget.style.color = 'var(--c-tx3)'}>
                                            &gt; CANCEL
                                        </button>
                                    </div>
                                </form>
