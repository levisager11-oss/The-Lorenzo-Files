...
export default function Header({ username, experiencePoints, lightMode, onToggleLightMode, onlineCount, onShowProfile, onShowLeaderboard, onShowGames, onShowChat, chatUnreadCount }) {
